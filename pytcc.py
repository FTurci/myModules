...
class TCC(object):
	...
	def __init__(self, fileName, totalFrames,desiredFrames='all',rcut=2.,fc=1,rho=None,boxType=0, box=None,startFrom=0, frequency=1,bondType=1,pbc=True,bonds=False, clust=False,raw=False,_11a=False, _13a=False, pop=False):
		...
		inputparameters(self.filename,self.boxType,desiredFrames,totalFrames, self.N,self.Na,self.rho, [rcut],fc,boxName="box.txt", startFrom=0, frequency=1,bondType=1,pbc=pbc,bonds=bonds,clus=clust, raw=raw,_11a=_11a, _13a=_13a, pop=pop)
